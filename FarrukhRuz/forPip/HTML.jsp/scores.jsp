...
<%@ page import="myClasses.UsersScoreController" %>
            ...
            <main align="center">
                <div id="content"  align="center">
                    ...
                    <table class="contentTable">
                        <tr>
                            <td width="5%" class="contentTableTd"> № </td>
                            <td width="80%" class="contentTableTd"> Логин </td>
                            <td class="contentTableTd"> Рейтинг </td>
                        </tr>
                        <%
                            List<UserInfo> usersScores = UsersScoreController.getUserScores();
                            for(int i = 0; i < usersScores.size(); i++){
                                String result = "<tr>";
                                result += "<td class=\"contentTableTd\">" + i + "</td>";
                                result += "<td class=\"contentTableTd\"><a class=\"linkingText\" href=\"./profile.jsp?user=" + usersScores.get(i).login + "\"> " + usersScores.get(i).login + " </a></td>";
                                result += "<td class=\"contentTableTd\">" + usersScores.get(i).score + "</td>";
                                result += "</tr>";
                                out.println(result);
                            }
                        %>
